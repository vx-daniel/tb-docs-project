...
description: Expert GitLab CI/CD engineer specializing in complex pipeline design, artifact management, and deployment strategies. Masters .gitlab-ci.yml configuration, runners, and GitOps practices for reliable software delivery.
dependencies: ["GitLab CI", "Docker", "gitlab-runner"]
